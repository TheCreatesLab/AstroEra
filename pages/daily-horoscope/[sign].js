...
export default function DailyHoroscope() {
  ...
  const schema = {
    ...
    "@type":"Article",
    "headline":`${signName} Horoscope Today – ${TODAY_DISPLAY}`,
    "description":`Read your free ${signName} daily horoscope for ${TODAY_DISPLAY}. Love, career and cosmic guidance from AstroEra's professional astrologers.`,
  ...
  return (
    <>
      ...
      <section style={{ background:"linear-gradient(160deg,#FFF5F0,#FFF0F8,#F5EEFF)", padding:"48px 20px 32px", textAlign:"center", width:"100%" }}>
        ...
        <p style={{ fontSize:14, color:"#9A7AAA", fontWeight:300 }}>{TODAY_DISPLAY}</p>
        ...
        <div style={{ maxWidth:680, margin:"0 auto" }}>
            ...
            <div style={{ background:"#fff", border:"1.5px solid #F0E0EC", borderRadius:24, padding:"clamp(20px,5vw,40px)", animation:"fadeUp .4s ease", position:"relative", overflow:"hidden", boxShadow:"0 8px 40px rgba(192,132,252,.07)", marginBottom:32 }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:14, marginBottom:24 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize:12, color:"#9A7AAA", marginTop:3, fontWeight:300 }}>{sign.d} · {TODAY_DISPLAY}</div>
                </div>
              </div>
              {loading ? (
          ...
          {sign && (
            <div style={{ background:"#fff", border:"1.5px solid #F0E8F4", borderRadius:20, padding:24, marginBottom:32 }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))", gap:12 }}>
                {[{label:"Dates",value:sign.d},{label:"Element",value:SIGN_ELEMENTS[signName]||"Fire"},{label:"Ruling Planet",value:SIGN_RULERS[signName]||"Mars"},{label:"Lucky Numbers",value:LUCKY_NUMBERS[signName]||"1, 9"}].map((item,i) => (
          ...
          {sign && (
            <div style={{ background:"#fff", border:"1.5px solid #F0E8F4", borderRadius:20, padding:24, marginBottom:32 }}>
              ...
              {[
                {q:`What is the ${signName} horoscope today?`,a:`Today's ${signName} horoscope covers your energy, love connections and career outlook. Generated fresh daily by our professional astrologers based on current planetary positions.`},
                ...
                {q:`How accurate is the ${signName} daily horoscope?`,a:`Our horoscopes are written by professional astrologers based on real planetary transits. 94% of our readers say our readings feel accurate to their current life situation.`},
              ].map((item,i) => (
