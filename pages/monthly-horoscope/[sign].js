...
export default function MonthlyHoroscope({ signParam }) {
  ...
  const schema = {
    ...
    "@type":"Article",
    "headline":`${signName} Monthly Horoscope ${MONTH_NAME}`,
    "description":`Read your free ${signName} monthly horoscope for ${MONTH_NAME}. Love, career, health and cosmic guidance from AstroEra.`,
  ...
  return (
    <>
      ...
      <section style={{ background:"linear-gradient(160deg,#FFF5F0,#FFF0F8,#F5EEFF)", padding:"48px 20px 32px", textAlign:"center", width:"100%" }}>
        ...
        <h1 style={{ fontFamily:"'Rozha One',serif", fontSize:"clamp(28px,6vw,52px)", color:"#1A0530", margin:"10px 0 8px", lineHeight:1.1 }}>{signName} Horoscope {MONTH_NAME}</h1>
            ...
            <div style={{ background:"#fff", border:"1.5px solid #F0E0EC", borderRadius:24, padding:"clamp(20px,5vw,40px)", animation:"fadeUp .4s ease", position:"relative", overflow:"hidden", boxShadow:"0 8px 40px rgba(192,132,252,.07)", marginBottom:32 }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:14, marginBottom:24 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize:12, color:"#9A7AAA", marginTop:3, fontWeight:300 }}>{MONTH_NAME}</div>
                </div>
              </div>
              {loading ? (
